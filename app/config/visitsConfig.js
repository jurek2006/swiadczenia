...
// - isPatronage(icd10arr, icd9, visitName) - czy jest to wizyta patronażowa (położnej lub pielęgniarki)
...
const patronage = {
    ...
    visitNamesToInclude: ['wizyta patronażowa'] //tablica dozwolonych nazw z których przynajmniej jeden musi się zawierać w nazwie wizyty dla patronażu
}
